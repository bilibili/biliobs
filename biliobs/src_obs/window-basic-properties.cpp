...
OBSBasicProperties::OBSBasicProperties(QWidget *parent, OBSSource source_)
	: QDialog                (parent),
	  ...
	  main                   (qobject_cast<BiLiOBSMainWid*>(parent)),
	  acceptClicked          (false),
	  source                 (source_),
...
{
	int cx = (int)config_get_int(App()->mGetGlobalConfig(), "PropertiesWindow",
			"cx");
	int cy = (int)config_get_int(App()->mGetGlobalConfig(), "PropertiesWindow",
			"cy");
	...
	setWindowTitle(QTStr("Basic.PropertiesWindow"));
...
void OBSBasicProperties::SourceRenamed(void *data, calldata_t *params)
{
	...
	QString title = QTStr("Basic.PropertiesWindow");
...
{
	config_set_int(App()->mGetGlobalConfig(), "PropertiesWindow", "cx",
			width());
	config_set_int(App()->mGetGlobalConfig(), "PropertiesWindow", "cy",
			height());
}
