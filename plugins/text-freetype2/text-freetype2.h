...
struct ft2_source {
	...
	FT_Matrix transform_matrix; //fixed point number. bits: 16.16. eg. 0x10000 = 1, 0x8000 = 0.5
	FT_Matrix fallback_transform;
	bool fake_bold; //for fonts that has no bold style
	bool fallback_fake_bold;
